...
Symmetric polynomials and factorization identities
Existence-based set definitions (“there exist” parameters)
Parity constraints and congruence obstructions
batch: 01_第一批100题
teacher: xieshuhong
---
...
$$
A = \{\, n \in \\mathbb{N} \mid \\exists a,b,c \\in \\mathbb{N} \text{ such that } n = a^3 + b^3 + c^3 - 3abc \,\}.
$$

Define

$$
B = \{\, n \in \\mathbb{N} \mid \\exists x,y,z \\in \\mathbb{N} \text{ such that } x+y>z,\ y+z>x,\ z+x>y,\ \text{and } n = (x+y-z)(y+z-x)(z+x-y) \,\}.
$$
...
$$
P = \{\, n \in \\mathbb{N} \mid 1 \\le n \\le 2016,\ n \\in A \\cap B \,\}.
$$

Task: Determine $|P|$, the number of elements of $P$.

## 解答
Both sets (A) and (B) are defined by “there exist integers … such that …”.
...
🔍 Step 1 — Characterize set (A) (mod 9)
...
(That’s exactly what we’ll use when intersecting with (B).)

🔍 Step 2 — Characterize set (B) (mod 8)
...
🧮 Step 3 — Reduce (P) to a pure congruence count (mod 72)
From the lemmas:
...
🧾 Step 4 — Count valid residues in one block of 72
